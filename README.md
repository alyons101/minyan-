...
## Features
- Onboarding flow to set your name (optional), primary area, and main shul (pick preset or add a custom one).
...
- History list with notes, travel labels, and tap-through detail view showing photos, location, and reflections.
